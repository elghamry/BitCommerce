...
class ForgetPassViewModel : ViewModel() {
    ...
    //livedata
    var forgetPassword: MutableLiveData<ForgetPasswordResponseModel> =
...
//        uploadImageResponseLiveData=Repository.uploadImageResponse
        ...
        forgetPassword = Repository.forgetPasswordResponse


    }

    fun forgetPass(user: ForgetPasswordModel) {
//        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
        Repository.forgetPassword(user)
