...
class HomeViewModel : ViewModel() {
    ...
    init {
        ...
        val offer = Offer("Hello Offer ","This is the descreption of the called offer ... !!!","https://previews.123rf.com/images/vectorgift/vectorgift1601/vectorgift160100019/50937688-super-sale-shining-banner-on-colorful-background-geometric-design-super-sale-and-special-offer-50-of.jpg")
        val offer2 = Offer("Hello Offer 2","This is the descreption of the called offer 2 ... !!!","https://fitsmallbusiness.com/wp-content/uploads/2018/05/23-Best-Sales-Promotion-Ideas.png")
        offers.add(offer)
        offers.add(offer2)
        offers.add(offer)
        offers.add(offer2)
...
//        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
        prods.add(Product(prods.size+1.toLong(),"https://www.wegmans.com/content/dam/wegmans/products/881/97881.jpg","Oat Meal Product","15 SR","good meal for bla bla oats !!i love it"))
        prods.add(Product(prods.size+1.toLong(),"https://usba.com.ua/sites/default/files/2017-10/87452883_0.jpg","Fish with Rice","20 SR","good meal for bla bla oats !!i love it"))
        prods.add(Product(prods.size+1.toLong(),"https://www.nowfoods.com/sites/default/files/styles/rbase-1440/public/fiber-2x.jpg?itok=0wDNDFqD&timestamp=1499351656","Multi Vitamin","30 SR","good meal for bla bla oats !!i love it"))
...
//        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
        bundles.add(BundleProds(bundles.size+1.toLong(),"https://cdn.shopify.com/s/files/1/0126/1214/1115/products/Paleo-Bundle_570x.png?v=1555949854","Hello best Bundle","15 SR","good meal for bla bla oats !!i love it"))
        bundles.add(BundleProds(bundles.size+1.toLong(),"https://www.duogreen.com/uploaded/201611161402165822187.jpg","Happy Bundles","20 SR","good meal for bla bla oats !!i love it"))
        bundles.add(BundleProds(bundles.size+1.toLong(),"https://cdn.shopify.com/s/files/1/0053/9952/products/mcp-flavors-strawberry-lemonade-bottle_FB_31594028-8061-492a-b206-22e8191d3140_1200x.jpg?v=1564771748","Juicy Lucy","30 SR","good meal for bla bla oats !!i love it"))
