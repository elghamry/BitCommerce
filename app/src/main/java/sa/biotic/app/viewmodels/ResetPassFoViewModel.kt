...
class ResetPassFoViewModel : ViewModel() {


    //livedata
    var resetPassFoResponse: MutableLiveData<ForgetPasswordResponseModel> =
...
//        uploadImageResponseLiveData=Repository.uploadImageResponse
        ...
        resetPassFoResponse = Repository.resetChanPassResponse

    }

    fun resetPassFo(user: ResetChangePassModel) {
//        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
        Repository.resetPasswordFo(user)
